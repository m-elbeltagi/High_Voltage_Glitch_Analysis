...
## this section opens the raw data dictionary and save it to aproccesed data dict, it uses the simple formula assuming underlying gaussian dist:
...
#    return a * np.exp(b*x)
#
#fit_parameters, pcov = curve_fit(exp_func, voltage_axis, rates_array)    


#plt.plot(voltage_axis, rates_array)
#plt.scatter(voltage_axis, rates_array, c = 'k')
#plt.ylabel('Rates (Hz)')       
#plt.xlabel('Voltage (kV)')
#plt.plot(voltage_axis, exp_func(np.array(voltage_axis), *fit_parameters), label='fit')
